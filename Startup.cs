...
namespace DeptEmailSender
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //to add DB
            services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DeptConnection")));
            services.AddTransient<IEmailSender, EmailSender>();                                       //DI(Dependency Injection)
